...
export default function AdminDashboard() {
    ...
    // 🔧 เก็บอินพุตของแท็ก/aliases เป็น string ตอนพิมพ์ (ค่อย split ตอน save)
    ...
    function normalizeForApi(it: ReviewItem) {
        // เก็บเป็น URL เต็ม (ถ้าอยากเก็บเป็น path เปล่า ๆ ให้เปลี่ยนเป็นคืน it.productImage / it.productGif ตรง ๆ)
        return {
            ...it,
    ...
    function editFromRow(row: any) {
        ...
        setProsInput((row.pros || []).join(",")); // ✅ pros เป็นคอมม่าคั่น
        setConsInput((row.cons || []).join(",")); // ✅ cons เป็นคอมม่าคั่น
    }
                ...
                <div className="space-y-3">
                    <div className="rounded-xl border border-white/10 bg-zinc-900/60 p-4">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            ...
                            <input
                                className="inp"
                                placeholder="ลิงก์รีวิว (TikTok/YouTube)"
                            ...
                            <p className="text-xs text-zinc-400">
                                ** รูป/ GIF กรุณาอัปโหลดไฟล์ไปที่ MiniPC เอง:
                                ...
                                แล้วใส่พาธเช่น <code>
                                    /img/ชื่อไฟล์.png
                                </code>, <code>/gif/ชื่อไฟล์.gif</code>
                            </p>
                        </div>
                    </div>
                </div>
