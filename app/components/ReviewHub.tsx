            ...
            <div className="shrink-0">
              ...
              >
                <span className="relative inline-flex w-5 h-5 overflow-hidden">
                  <AnimatePresence mode="wait" initial={false}>
                    {isFull ? (
                      <motion.span key="rows-m" initial={{ y: 12, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: -12, opacity: 0 }} transition={{ duration: 0.18 }} className="absolute inset-0 grid place-items-center">
                        <Rows size={18} />
                      </motion.span>
                    ) : (
                      <motion.span key="grid-m" initial={{ y: 12, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: -12, opacity: 0 }} transition={{ duration: 0.18 }} className="absolute inset-0 grid place-items-center">
                        <LayoutGrid size={18} />
                      </motion.span>
                    )}
                  </AnimatePresence>
